...
import io.github.devildare687.stealthmesh.model.FragmentPayload
...
class FragmentManager {
    ...
    companion object {
        ...
        private const val FRAGMENT_SIZE_THRESHOLD = io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.FRAGMENT_SIZE_THRESHOLD // Matches iOS: if data.count > 512
        private const val MAX_FRAGMENT_SIZE = io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE        // Matches iOS: maxFragmentSize = 469
        private const val FRAGMENT_TIMEOUT = io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.FRAGMENT_TIMEOUT_MS     // Matches iOS: 30 seconds cleanup
        private const val CLEANUP_INTERVAL = io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.CLEANUP_INTERVAL_MS     // 10 seconds cleanup check
    }
    ...
    fun handleFragment(packet: BitchatPacket): BitchatPacket? {
        ...
        try {
            ...
            val maxFragments = io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID
            ...
            synchronized(fragmentStateLock) {
                ...
                if (isNewSet) {
                    val maxActive = io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.MAX_ACTIVE_FRAGMENT_SETS
                ...
                val maxTotalBytes = io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.MAX_FRAGMENT_TOTAL_BYTES
                ...
                val maxGlobalBytes = io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.MAX_GLOBAL_FRAGMENT_TOTAL_BYTES
