...
import io.github.devildare687.stealthmesh.geohash.GeohashNostrPrivacyPolicy
import io.github.devildare687.stealthmesh.geohash.LiveLocationPrivacyGate
import io.github.devildare687.stealthmesh.nostr.GeohashMessageHandler
import io.github.devildare687.stealthmesh.nostr.GeohashRepository
import io.github.devildare687.stealthmesh.nostr.NostrBackgroundRuntime
import io.github.devildare687.stealthmesh.nostr.NostrIdentityBridge
import io.github.devildare687.stealthmesh.nostr.NostrProtocol
import io.github.devildare687.stealthmesh.nostr.NostrRelayManager
import io.github.devildare687.stealthmesh.nostr.NostrSubscriptionManager
import io.github.devildare687.stealthmesh.nostr.PoWPreferenceManager
import io.github.devildare687.stealthmesh.nostr.GeohashAliasRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: io.github.devildare687.stealthmesh.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = io.github.devildare687.stealthmesh.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(io.github.devildare687.stealthmesh.geohash.ChannelID.Mesh)
    ...
    fun panicReset() {
        ...
        try { io.github.devildare687.stealthmesh.nostr.NostrRelayManager.getInstance(getApplication()).clearAllOnPanic() } catch (_: Exception) {}
        try { io.github.devildare687.stealthmesh.nostr.LocationNotesManager.getInstance().stop() } catch (_: Exception) {}
    }

    fun sendGeohashMessage(content: String, channel: io.github.devildare687.stealthmesh.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = io.github.devildare687.stealthmesh.model.BitchatMessage(
                    id = tempId,
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? io.github.devildare687.stealthmesh.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = io.github.devildare687.stealthmesh.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: io.github.devildare687.stealthmesh.geohash.ChannelID?) {
        ...
        when (channel) {
            is io.github.devildare687.stealthmesh.geohash.ChannelID.Mesh -> {
            ...
            is io.github.devildare687.stealthmesh.geohash.ChannelID.Location -> {
                if (locationChannelManager?.canUseSelectedLocationChannel(channel.channel) != true) {
                    ...
                    switchLocationChannel(io.github.devildare687.stealthmesh.geohash.ChannelID.Mesh)
                    return
                }
    ...
    override fun onStart(owner: LifecycleOwner) {
        ...
        val selectedLocation = selected as? io.github.devildare687.stealthmesh.geohash.ChannelID.Location
