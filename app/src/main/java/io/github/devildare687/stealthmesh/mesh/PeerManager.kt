...
class PeerManager {
    ...
    private val stalePeerTimeoutMs: Long = io.github.devildare687.stealthmesh.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS
    ...
    private fun startPeriodicCleanup() {
        managerScope.launch {
            while (isActive) {
                delay(io.github.devildare687.stealthmesh.util.AppConstants.Mesh.PEER_CLEANUP_INTERVAL_MS)
                cleanupStalePeers()
            }
        }
    }
