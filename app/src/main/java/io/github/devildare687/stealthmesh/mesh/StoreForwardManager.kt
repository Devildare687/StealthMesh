...
class StoreForwardManager {
    ...
    companion object {
        ...
        private const val MESSAGE_CACHE_TIMEOUT = io.github.devildare687.stealthmesh.util.AppConstants.StoreForward.MESSAGE_CACHE_TIMEOUT_MS  // 12 hours for regular peers
        private const val MAX_CACHED_MESSAGES = io.github.devildare687.stealthmesh.util.AppConstants.StoreForward.MAX_CACHED_MESSAGES  // For regular peers
        private const val MAX_CACHED_MESSAGES_FAVORITES = io.github.devildare687.stealthmesh.util.AppConstants.StoreForward.MAX_CACHED_MESSAGES_FAVORITES  // For favorites
        private const val CLEANUP_INTERVAL = io.github.devildare687.stealthmesh.util.AppConstants.StoreForward.CLEANUP_INTERVAL_MS // 10 minutes
    }
