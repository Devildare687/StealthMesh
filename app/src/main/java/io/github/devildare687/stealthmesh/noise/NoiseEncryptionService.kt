package io.github.devildare687.stealthmesh.noise

import android.content.Context
import android.util.Log
import io.github.devildare687.stealthmesh.identity.SecureIdentityStateManager
import io.github.devildare687.stealthmesh.mesh.PeerFingerprintManager
import io.github.devildare687.stealthmesh.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = io.github.devildare687.stealthmesh.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = io.github.devildare687.stealthmesh.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = io.github.devildare687.stealthmesh.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: io.github.devildare687.stealthmesh.protocol.BitchatPacket): io.github.devildare687.stealthmesh.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: io.github.devildare687.stealthmesh.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
