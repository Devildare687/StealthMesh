...
import io.github.devildare687.stealthmesh.ui.debug.DebugSettingsManager
import io.github.devildare687.stealthmesh.ui.debug.DebugScanResult
...
class BluetoothGattClientManager(
    ...
    private fun handleScanResult(result: ScanResult) {
        ...
        val dbg = try { io.github.devildare687.stealthmesh.ui.debug.DebugSettingsManager.getInstance() } catch (_: Exception) { null }
