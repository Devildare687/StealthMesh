...
import io.github.devildare687.stealthmesh.crypto.EncryptionService
import io.github.devildare687.stealthmesh.model.BitchatMessage
import io.github.devildare687.stealthmesh.model.AuthenticatedPeerState
import io.github.devildare687.stealthmesh.model.PeerCapabilities
import io.github.devildare687.stealthmesh.protocol.MessagePadding
import io.github.devildare687.stealthmesh.model.RoutedPacket
import io.github.devildare687.stealthmesh.model.IdentityAnnouncement
import io.github.devildare687.stealthmesh.model.NoisePayload
import io.github.devildare687.stealthmesh.model.NoisePayloadType
...
import io.github.devildare687.stealthmesh.protocol.SpecialRecipients
import io.github.devildare687.stealthmesh.model.RequestSyncPacket
import io.github.devildare687.stealthmesh.sync.GossipSyncManager
import io.github.devildare687.stealthmesh.util.toHexString
import io.github.devildare687.stealthmesh.services.VerificationService
import io.github.devildare687.stealthmesh.service.TransportBridgeService
...
class BluetoothMeshService(private val context: Context) : TransportBridgeService.TransportLayer {
    ...
    companion object {
        ...
        private val MAX_TTL: UByte = io.github.devildare687.stealthmesh.util.AppConstants.MESSAGE_TTL_HOPS
        private const val PEER_DISCONNECT_GRACE_MS = io.github.devildare687.stealthmesh.util.AppConstants.Mesh.PEER_DISCONNECT_GRACE_MS
    }
    ...
    private val privateMediaPreparer by lazy {
        PrivateMediaTransferPreparer(
            ...
            encrypt = { plaintext, peerID, authenticatedSession ->
                ...
                } catch (_: io.github.devildare687.stealthmesh.noise.NoiseSessionError.SessionGenerationChanged) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: io.github.devildare687.stealthmesh.noise.NoiseSessionError.SessionNotFound) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: io.github.devildare687.stealthmesh.noise.NoiseSessionError.SessionNotEstablished) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: Exception) {
    ...
    private val serviceNotificationManager = io.github.devildare687.stealthmesh.ui.NotificationManager(
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    io.github.devildare687.stealthmesh.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    io.github.devildare687.stealthmesh.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    io.github.devildare687.stealthmesh.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
                } catch (_: Exception) { 0.01 }
            }
        )

        io.github.devildare687.stealthmesh.service.MeshServiceHolder.setGossipManager(gossipSyncManager) { packet ->
    ...
    private fun isBleTransportEnabled(): Boolean {
        return try {
            io.github.devildare687.stealthmesh.ui.debug.DebugSettingsManager.getInstance().bleEnabled.value
        } catch (_: Exception) {
            try { io.github.devildare687.stealthmesh.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        }
    }
    ...
    private fun setupDelegates() {
        ...
        peerManager.delegate = object : PeerManagerDelegate {
            override fun onPeerListUpdated(peerIDs: List<String>) {
                ...
                try { io.github.devildare687.stealthmesh.services.AppStateStore.setTransportPeers("BLE", peerIDs) } catch (_: Exception) { }
            ...
            override fun onPeerRemoved(peerID: String) {
                ...
                try { io.github.devildare687.stealthmesh.services.meshgraph.MeshGraphService.getInstance().removePeer(peerID) } catch (_: Exception) { }
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun updatePeerInfoFromVerifiedAnnouncement(peerID: String, nickname: String, noisePublicKey: ByteArray, signingPublicKey: ByteArray, isVerified: Boolean, capabilities: io.github.devildare687.stealthmesh.model.PeerCapabilities?): Boolean {
            ...
            override fun decryptFromPeer(
                ...
                senderPeerID: String
            ): io.github.devildare687.stealthmesh.noise.NoiseDecryptionResult? {
            ...
            override fun onAuthenticatedPeerStateReceived(
                ...
                authenticatedSession: io.github.devildare687.stealthmesh.noise.AuthenticatedNoiseSession
            ) {
            ...
            override fun onMessageReceived(message: BitchatMessage) {
                ...
                if (
                    !io.github.devildare687.stealthmesh.services.IncomingMessageAdmission
                ...
                if (delegate == null && message.isPrivate && message.sender != "system") {
                    try {
                        ...
                        if (senderPeerID != null) {
                            ...
                            val preview = io.github.devildare687.stealthmesh.ui.NotificationTextUtils.buildPrivateMessagePreview(message)
            ...
            override fun onDeliveryAckReceived(messageID: String, peerID: String) {
                ...
                try {
                    io.github.devildare687.stealthmesh.services.AppStateStore.updatePrivateMessageStatus(
                        messageID,
                        io.github.devildare687.stealthmesh.model.DeliveryStatus.Delivered(peerID, Date())
                    )
                } catch (_: Exception) { }
            ...
            override fun onReadReceiptReceived(messageID: String, peerID: String) {
                try {
                    io.github.devildare687.stealthmesh.services.AppStateStore.updatePrivateMessageStatus(
                        messageID,
                        io.github.devildare687.stealthmesh.model.DeliveryStatus.Read(peerID, Date())
                    )
                } catch (_: Exception) { }
        ...
        override fun onPacketReceived(
            ...
            try {
                io.github.devildare687.stealthmesh.ui.debug.DebugSettingsManager.getInstance().logIncoming(
                    packet = packet,
                    fromPeerID = peerID,
                    fromNickname = null,
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    io.github.devildare687.stealthmesh.ui.debug.DebugSettingsManager.getInstance()
    ...
    fun startServices() {
        ...
        if (!isBleTransportEnabled()) {
            ...
            io.github.devildare687.stealthmesh.service.MeshServiceHolder.stopSharedGossip("BLE")
            try { io.github.devildare687.stealthmesh.services.AppStateStore.clearTransportPeers("BLE") } catch (_: Exception) { }
            try { io.github.devildare687.stealthmesh.services.AppStateStore.clearTransportDirectPeers("BLE") } catch (_: Exception) { }
            return
        }
        if (terminated) {
        ...
        if (connectionManager.startServices()) {
            ...
            io.github.devildare687.stealthmesh.service.MeshServiceHolder.startSharedGossip("BLE")
        } else {
    ...
    fun sendFileBroadcast(file: io.github.devildare687.stealthmesh.model.BitchatFilePacket) {
        try {
    ...
    fun sendFilePrivate(recipientPeerID: String, file: io.github.devildare687.stealthmesh.model.BitchatFilePacket) {
    ...
    fun prepareFilePrivate(
        ...
        file: io.github.devildare687.stealthmesh.model.BitchatFilePacket,
        transferId: String,
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = io.github.devildare687.stealthmesh.model.PrivateMessagePacket(
                    ...
                    val messagePayload = io.github.devildare687.stealthmesh.model.NoisePayload(
                        type = io.github.devildare687.stealthmesh.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            val geo = runCatching { io.github.devildare687.stealthmesh.services.MessageRouter.tryGetInstance() }.getOrNull()
            val isGeoAlias = try {
                val map = io.github.devildare687.stealthmesh.nostr.GeohashAliasRegistry.snapshot()
                map.containsKey(recipientPeerID)
            } catch (_: Exception) { false }
            if (isGeoAlias && geo != null) {
                geo.sendReadReceipt(io.github.devildare687.stealthmesh.model.ReadReceipt(messageID), recipientPeerID)
                return@launch
            }

            try {
                // Create read receipt payload using NoisePayloadType exactly like iOS
                val readReceiptPayload = io.github.devildare687.stealthmesh.model.NoisePayload(
                    type = io.github.devildare687.stealthmesh.model.NoisePayloadType.READ_RECEIPT,
                ...
                val packet = BitchatPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = io.github.devildare687.stealthmesh.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS messageTTL
                )
                ...
                readReceiptRetrySender.enqueue(
                    ...
                    onComplete = { accepted ->
                        if (accepted) {
                            try {
                                io.github.devildare687.stealthmesh.services.SeenMessageStore
        ...
        serviceScope.launch {
            try {
                ...
                val packet = BitchatPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = io.github.devildare687.stealthmesh.util.AppConstants.MESSAGE_TTL_HOPS
                )
    ...
    fun sendBroadcastAnnounce() {
        serviceScope.launch {
            val nickname = try { io.github.devildare687.stealthmesh.services.NicknameProvider.getNickname(context, myPeerID) } catch (_: Exception) { myPeerID }
            ...
            try {
                ...
                if (directPeers.isNotEmpty()) {
                    val gossip = io.github.devildare687.stealthmesh.services.meshgraph.GossipTLV.encodeNeighbors(directPeers)
                    tlvPayload = tlvPayload + gossip
                }
                // Always update our own node in the mesh graph with the neighbor list we used
                try {
                    io.github.devildare687.stealthmesh.services.meshgraph.MeshGraphService.getInstance()
    ...
    private fun getDirectPeerIDsForGossip(): List<String> {
        return try {
            ...
            try { io.github.devildare687.stealthmesh.services.AppStateStore.setTransportDirectPeers("BLE", direct) } catch (_: Exception) { }
            val union = try {
                io.github.devildare687.stealthmesh.services.AppStateStore.getDirectPeers().ifEmpty { direct }
     ...
     */
    fun getSessionState(peerID: String): io.github.devildare687.stealthmesh.noise.NoiseSession.NoiseSessionState {
    ...
    private fun applyRouteIfAvailable(packet: BitchatPacket): BitchatPacket {
        return try {
            ...
            if (recipient != null && !recipient.contentEquals(SpecialRecipients.BROADCAST)) {
                ...
                val path = io.github.devildare687.stealthmesh.services.meshgraph.RoutePlanner.shortestPath(
                    myPeerID,
                    destination
                )
