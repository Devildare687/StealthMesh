...
internal class PrivateMediaTransferPreparer(
    ...
    private fun prepare(
        ...
        val maxPrivateFragments =
            io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID
        val absolutePayloadUpperBound =
            maxPrivateFragments.toLong() *
                io.github.devildare687.stealthmesh.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE.toLong()
