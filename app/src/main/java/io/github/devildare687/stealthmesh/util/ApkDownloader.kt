...
internal fun downloadPhaseLabel(phase: ApkDownloader.DownloadPhase): Int = when (phase) {
    ApkDownloader.DownloadPhase.AwaitingConnectivity ->
        io.github.devildare687.stealthmesh.R.string.prepare_apk_phase_awaiting_connectivity
    ApkDownloader.DownloadPhase.Retrying ->
        io.github.devildare687.stealthmesh.R.string.prepare_apk_phase_retrying
    ApkDownloader.DownloadPhase.SelectingSource ->
        io.github.devildare687.stealthmesh.R.string.prepare_apk_phase_selecting_source
    ApkDownloader.DownloadPhase.AwaitingNetworkRoute ->
        io.github.devildare687.stealthmesh.R.string.prepare_apk_phase_awaiting_route
    ApkDownloader.DownloadPhase.Transferring ->
        io.github.devildare687.stealthmesh.R.string.prepare_apk_phase_transferring
    ApkDownloader.DownloadPhase.VerifyingSignature ->
        io.github.devildare687.stealthmesh.R.string.prepare_apk_phase_verifying_signature
}
