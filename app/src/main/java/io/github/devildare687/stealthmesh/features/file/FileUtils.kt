package io.github.devildare687.stealthmesh.features.file
...
object FileUtils {
     ...
     */
    fun messageTypeForMime(mime: String): io.github.devildare687.stealthmesh.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> io.github.devildare687.stealthmesh.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> io.github.devildare687.stealthmesh.model.BitchatMessageType.Audio
            else -> io.github.devildare687.stealthmesh.model.BitchatMessageType.File
        }
    }
