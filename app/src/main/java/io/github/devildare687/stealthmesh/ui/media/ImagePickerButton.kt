...
import io.github.devildare687.stealthmesh.features.media.ImageUtils
import io.github.devildare687.stealthmesh.ui.ComposerActionSurface
import io.github.devildare687.stealthmesh.ui.ComposerIconSize
import java.io.File
...
fun ImagePickerButton(
    ...
    val takePictureLauncher = rememberLauncherForActivityResult(
        ...
        if (success && !path.isNullOrBlank()) {
            ...
            val outPath = io.github.devildare687.stealthmesh.features.media.ImageUtils.downscalePathAndSaveToAppFiles(context, path)
    ...
    ComposerActionSurface(
        ...
        Icon(
            ...
            contentDescription = stringResource(io.github.devildare687.stealthmesh.R.string.pick_image),
            tint = tint,
