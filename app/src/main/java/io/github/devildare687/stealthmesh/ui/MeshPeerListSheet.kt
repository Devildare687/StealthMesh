...
import io.github.devildare687.stealthmesh.core.ui.component.sheet.BitchatSheetCenterTopBar
import io.github.devildare687.stealthmesh.core.ui.component.sheet.LocalSheetDismiss
import io.github.devildare687.stealthmesh.core.ui.component.sheet.BitchatSheetTitle
import io.github.devildare687.stealthmesh.core.ui.component.sheet.BitchatSheetTopBar
import io.github.devildare687.stealthmesh.favorites.FavoriteRelationship
import io.github.devildare687.stealthmesh.favorites.FavoritesPersistenceService
import io.github.devildare687.stealthmesh.geohash.ChannelID
...
import io.github.devildare687.stealthmesh.ui.theme.BASE_FONT_SIZE
...
import io.github.devildare687.stealthmesh.ui.theme.colorForPeer
...
fun MeshPeerListSheet(
    ...
    val wifiAwareConnected by io.github.devildare687.stealthmesh.wifiaware.WifiAwareController.connectedPeers.collectAsStateWithLifecycle()
                ...
                LazyColumn(
                    ...
                    when {
                        conversationStoreState is
                            io.github.devildare687.stealthmesh.services.ConversationStoreState.Loading &&
                        ...
                        conversationStoreState is
                            io.github.devildare687.stealthmesh.services.ConversationStoreState.Error &&
                            conversations.isEmpty() -> {
