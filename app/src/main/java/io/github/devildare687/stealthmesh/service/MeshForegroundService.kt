package io.github.devildare687.stealthmesh.service
...
import io.github.devildare687.stealthmesh.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "io.github.devildare687.stealthmesh.service.START"
        const val ACTION_STOP = "io.github.devildare687.stealthmesh.service.STOP"
        const val ACTION_QUIT = "io.github.devildare687.stealthmesh.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "io.github.devildare687.stealthmesh.service.UPDATE_NOTIFICATION"
    ...
    private val unifiedMeshService: io.github.devildare687.stealthmesh.mesh.MeshService?
    ...
    override fun onCreate() {
        ...
        updateJob = scope.launch {
            io.github.devildare687.stealthmesh.services.AppStateStore.peers
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when (intent?.action) {
            ACTION_STOP -> {
                ...
                updateJob?.cancel()
                updateJob = null
                try { io.github.devildare687.stealthmesh.services.MessageRouter.tryGetInstance()?.stopOutboxScheduler() } catch (_: Exception) { }
