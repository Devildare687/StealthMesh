...
import io.github.devildare687.stealthmesh.noise.AuthenticatedNoiseSession
import io.github.devildare687.stealthmesh.noise.NoiseDecryptionResult
...
class SecurityManager(private val encryptionService: EncryptionService, private val myPeerID: String) {
    ...
    companion object {
        ...
        private const val MESSAGE_TIMEOUT = io.github.devildare687.stealthmesh.util.AppConstants.Security.MESSAGE_TIMEOUT_MS // 5 minutes (same as iOS)
        private const val CLEANUP_INTERVAL = io.github.devildare687.stealthmesh.util.AppConstants.Security.CLEANUP_INTERVAL_MS // 5 minutes
        private const val MAX_PROCESSED_MESSAGES = io.github.devildare687.stealthmesh.util.AppConstants.Security.MAX_PROCESSED_MESSAGES
        private const val MAX_PROCESSED_KEY_EXCHANGES = io.github.devildare687.stealthmesh.util.AppConstants.Security.MAX_PROCESSED_KEY_EXCHANGES
        private const val KEY_EXCHANGE_DEDUP_TIMEOUT = io.github.devildare687.stealthmesh.util.AppConstants.Security.KEY_EXCHANGE_DEDUP_TIMEOUT_MS
    }
    ...
    fun validatePacket(packet: BitchatPacket, peerID: String): Boolean {
        ...
        if (processedMessages.contains(messageID)) {
            ...
            val isFreshAnnounce = messageType == MessageType.ANNOUNCE &&
                    packet.ttl >= io.github.devildare687.stealthmesh.util.AppConstants.MESSAGE_TTL_HOPS
    ...
    suspend fun handleNoiseHandshake(routed: RoutedPacket): Boolean {
        ...
        try {
            ...
            if (result.establishedNow) {
                ...
                val isDirectIngress = packet.ttl == io.github.devildare687.stealthmesh.util.AppConstants.MESSAGE_TTL_HOPS
