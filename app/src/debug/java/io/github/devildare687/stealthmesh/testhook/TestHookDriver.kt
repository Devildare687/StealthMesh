package io.github.devildare687.stealthmesh.testhook

import android.content.Context
import android.content.Intent
import android.util.Log
import io.github.devildare687.stealthmesh.favorites.FavoritesPersistenceService
import io.github.devildare687.stealthmesh.features.file.FileUtils
import io.github.devildare687.stealthmesh.features.voice.LiveVoiceEvent
...
import io.github.devildare687.stealthmesh.features.voice.LiveVoiceCapture
...
import io.github.devildare687.stealthmesh.mesh.PrivateMediaPreparation
import io.github.devildare687.stealthmesh.mesh.TransferProgressManager
...
import io.github.devildare687.stealthmesh.service.MeshForegroundService
...
import io.github.devildare687.stealthmesh.ui.PrivateMediaRecipientResolver
...
object TestHookDriver {
    ...
    private suspend fun msgRecv(context: Context, intent: Intent): JSONObject {
        ...
        val startTime = System.currentTimeMillis()
        val mesh = mesh(context)
        val matches: (io.github.devildare687.stealthmesh.model.BitchatMessage) -> Boolean = { msg ->
            msg.timestamp.time >= startTime &&
                msg.senderPeerID != mesh.myPeerID &&
                (contains == null || msg.content.contains(contains)) &&
