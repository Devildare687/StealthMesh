 ...
 *
 * Usage:
 *   adb shell am broadcast -a io.github.devildare687.stealthmesh.TEST_HOOK \
 ...
 *   adb shell run-as io.github.devildare687.stealthmesh cat cache/testhook/results/<id>.json
 */
class TestHookReceiver : BroadcastReceiver() {

    companion object {
        const val TAG = "TestHook"
        const val ACTION = "io.github.devildare687.stealthmesh.TEST_HOOK"
