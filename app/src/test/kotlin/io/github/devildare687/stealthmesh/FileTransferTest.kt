...
class FileTransferTest {
    ...
    fun `replaceFilePathInContent should correctly format content markers for different file types`() {
        ...
        val imageMessage = BitchatMessage(
            ...
            content = "/data/user/0/io.github.devildare687.stealthmesh/files/images/photo.jpg",
        ...
        val audioMessage = BitchatMessage(
            ...
            content = "/data/user/0/io.github.devildare687.stealthmesh/files/audio/voice.amr",
        ...
        val fileMessage = BitchatMessage(
            ...
            content = "/data/user/0/io.github.devildare687.stealthmesh/files/documents/document.pdf",
        ...
        result = result.replace(
            "/data/user/0/io.github.devildare687.stealthmesh/files/images/photo.jpg",
            "[image] photo.jpg"
        )
    ...
    fun `media picker should handle file size limits correctly`() {
        ...
        val maxAllowedSize = io.github.devildare687.stealthmesh.util.AppConstants.Media.MAX_FILE_SIZE_BYTES
