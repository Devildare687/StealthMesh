...
import io.github.devildare687.stealthmesh.noise.NoiseHandshakeProcessingResult
import io.github.devildare687.stealthmesh.noise.NoisePeerIdentity
import io.github.devildare687.stealthmesh.noise.NoiseSessionError
...
class SecurityManagerTest {
    ...
    fun `validatePacket - handles ANNOUNCE duplicates correctly`() {
        ...
        val packet1 = BitchatPacket(
            type = MessageType.ANNOUNCE.value,
            ttl = io.github.devildare687.stealthmesh.util.AppConstants.MESSAGE_TTL_HOPS, // 7u
            senderID = unknownPeerID,
            payload = payload
        )
        ...
        val packet2 = packet1.copy(ttl = (io.github.devildare687.stealthmesh.util.AppConstants.MESSAGE_TTL_HOPS - 1u).toUByte())
        ...
        val packet3 = packet1.copy(ttl = io.github.devildare687.stealthmesh.util.AppConstants.MESSAGE_TTL_HOPS)
    ...
    fun `handshake dedup entries expire by time and allow delayed retry`() = runBlocking {
        ...
        securityManager.cleanupOldData(
            System.currentTimeMillis() +
                io.github.devildare687.stealthmesh.util.AppConstants.Security.KEY_EXCHANGE_DEDUP_TIMEOUT_MS + 1_000
        )
