 ...
 *
 *   adb shell am broadcast -a io.github.devildare687.stealthmesh.watch.TEST_HOOK \
 *     --es cmd <command> --es id <cmd-id> [command extras...]
 *
 * Result is written to cache/testhook/results/<id>.json (readable via run-as io.github.devildare687.stealthmesh.watch)
...
class WearTestHookReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION = "io.github.devildare687.stealthmesh.watch.TEST_HOOK"
