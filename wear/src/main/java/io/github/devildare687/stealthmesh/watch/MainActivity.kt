...
import io.github.devildare687.stealthmesh.watch.ui.ChatScreen
import io.github.devildare687.stealthmesh.watch.ui.DmScreen
import io.github.devildare687.stealthmesh.watch.ui.NicknameSetupScreen
import io.github.devildare687.stealthmesh.watch.ui.PeopleScreen
import io.github.devildare687.stealthmesh.watch.ui.UserDetailScreen
import io.github.devildare687.stealthmesh.watch.ui.VerificationCodeScreen
import io.github.devildare687.stealthmesh.watch.ui.WearChatState
import io.github.devildare687.stealthmesh.watch.ui.sendPrivateMessage
import io.github.devildare687.stealthmesh.watch.ui.sendPublicMessage
import io.github.devildare687.stealthmesh.watch.ui.theme.BitchatWearTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onResume() {
        super.onResume()
        io.github.devildare687.stealthmesh.features.voice.LiveVoiceManager.getInstance(applicationContext)
...
internal fun WearNavHost(
    ...
    AnimatedContent(
        ...
        transitionSpec = {
            fadeIn(tween(io.github.devildare687.stealthmesh.watch.ui.theme.BitchatMotion.EMPHASIZED_MS)) togetherWith
                fadeOut(tween(io.github.devildare687.stealthmesh.watch.ui.theme.BitchatMotion.QUICK_MS))
        },
        ...
        when (current) {
            ...
            is WearScreen.TextInput -> {
                ...
                io.github.devildare687.stealthmesh.watch.ui.TextInputScreen(
                    onSend = { text ->
                        mesh?.let { m ->
