...
class ReleaseGateTest(unittest.TestCase):
    ...
    def test_disposable_cleanup_targets_the_real_application_id(self, run_adb):
        ...
        self.assertEqual(
            [
                mock.call(
                    "ephemeral-selector",
                    ["shell", "am", "force-stop", "io.github.devildare687.stealthmesh"],
                ),
                mock.call(
                    "ephemeral-selector",
                    ["shell", "pm", "clear", "io.github.devildare687.stealthmesh"],
                ),
            ],
    ...
    def test_resource_snapshot_returns_only_aggregate_metrics(self, run_adb):
        run_adb.side_effect = [
            ...
            "7",
            "11",
            "WakeLock io.github.devildare687.stealthmesh\nWakeLock another.package",
            "level: 73",
        ]
        ...
        self.assertEqual(
            mock.call(
                "ephemeral-selector",
                ["shell", "pidof", "io.github.devildare687.stealthmesh"],
            ),
